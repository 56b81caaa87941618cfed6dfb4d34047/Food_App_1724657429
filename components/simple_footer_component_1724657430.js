...
Vue.component("simple_footer_component_1724657430", {
    template: `
    <footer id="footer-section" style="min-height: 470px" class="flex-1 bg-gradient-to-r from-pink-400 to-purple-600 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
